...
function setup() {
  ...
  kangaroo = createSprite(50,50,50,50)
  kangaroo.addAnimation("kangaroo_running,kangaroo_collided");
  kangaroo.scale=0.1;

//Create a sprite for Invisible ground and place it at the bottom side of the screen.
  invground = createSprite(50,50,350,350);
...
//Set the x-position of the shrub according to the game camera.
    camera.position.y = shrub.position.x;
